...
const BALL_TYPES = [
  ...
  { name: "Chicken", sub: "ground thigh, parm", icon: "ph-egg" },
  { name: "Pork", sub: "fennel, garlic, breadcrumb", icon: "ph-circle-dashed" },
  { name: "Veggie", sub: "lentil + mushroom, herb", icon: "ph-leaf" },
  {
